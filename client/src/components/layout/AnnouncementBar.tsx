      ...
      <div className="flex-1 overflow-hidden relative flex items-center px-2">
        <div className="animate-ticker text-[#243746] font-medium text-xs flex items-center space-x-8">
          <span className="flex items-center space-x-1.5">
            ...
            <span>
              <strong>Citizen Advisory:</strong> Check your land acquisition case status, compensation valuation schedule, and pending verification actions online.
            </span>
          </span>
          ...
          <span className="flex items-center space-x-1.5">
            ...
            <span>
              <strong>Document Intelligence:</strong> Upload your Section 11(1) notice to cross-check area measurements against certified revenue records and detect discrepancies.
            </span>
          </span>
          ...
          <span className="flex items-center space-x-1.5">
            ...
            <span>
              <strong>Statutory Objections:</strong> File Section 15 inquiries directly with the Land Acquisition Officer from the Grievances tab.
            </span>
          </span>
          ...
          <span className="flex items-center space-x-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-[#E8B84A]"></span>
            <span>
              <strong>Direct Benefit Transfer:</strong> Ensure your Aadhaar is mapped to your active bank account for seamless compensation disbursement.
            </span>
          </span>
        </div>
      </div>
