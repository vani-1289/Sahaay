...
import { Shield, User, Lock, ArrowRight, CheckCircle2, UserCheck, Briefcase, Building, Landmark } from 'lucide-react';
        ...
        <div className="hidden lg:flex lg:col-span-5 relative bg-[#123B5D] p-10 flex-col justify-between text-white overflow-hidden">
          ...
          <div className="relative z-10 space-y-3 bg-white/10 backdrop-blur-md p-5 rounded-xl border border-white/15">
            <p className="text-xs text-slate-200 leading-relaxed font-medium">
              "A simpler, transparent way to discover what is happening to your land, understand official notices, and receive fair statutory compensation."
            </p>
            <div className="text-[11px] text-[#E8B84A] font-bold uppercase tracking-wider">
              Citizen-First Public Service Platform
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 p-6 sm:p-10 flex flex-col justify-center space-y-6">
          <div className="space-y-1 text-center sm:text-left">
            ...
            <p className="text-xs sm:text-sm text-[#667784]">
              Sign in to access your land parcel records, case dossier, and compensation updates.
            </p>
          </div>
          ...
          <div className="bg-[#F5FAFC] border border-[#DDE6EC] p-3.5 rounded-xl space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <div className="text-xs font-bold">🌾 Citizen / Landowner</div>
                <div className="text-[10px] opacity-80 truncate">Rajesh Sharma (Survey 1042)</div>
              </button>
              <button
                type="button"
              ...
              >
                <div className="text-xs font-bold">🏛️ Land Officer (LAO)</div>
                <div className="text-[10px] opacity-80 truncate">Vikram Chouhan (Bhopal)</div>
              </button>
            </div>
          </div>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <>
                    <div>
                      <label className="block text-xs font-semibold text-[#123B5D] mb-1">
                        Full Name (as per Revenue Record / Aadhaar)
                      </label>
                      <input
                        type="text"
                        required
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-xs font-semibold text-[#123B5D] mb-1">Village</label>
                        <input
                          type="text"
                          value={village}
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-[#123B5D] mb-1">District</label>
                        <input
                          type="text"
                          value={district}
                ...
                >
                  {loading ? (
                    ...
                    <>
                      <span>{isRegister ? 'Create Citizen Account' : 'Sign In to Sahaay'}</span>
          ...
          <div className="text-center text-[11px] text-[#667784]">
            Protected by Sahaay Digital Trust Layer • Public Service Demonstration
          </div>
        </div>
      </div>
    </div>
