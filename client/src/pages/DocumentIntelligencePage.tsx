...
export const DocumentIntelligencePage: React.FC = () => {
  ...
  const demoSamples = [
    {
      id: 'demo-notice-1042',
      title: 'Gazette Acquisition Notice Section 11(1) — Survey #1042',
      sub: 'Contains 2.73 ha area mismatch for verification check',
      filename: 'Gazette_Notice_Sec11_Survey1042.pdf',
      type: 'ACQUISITION_NOTICE',
    },
    {
      id: 'demo-khasra-1042',
      title: 'Certified Khasra B-1 Revenue Record — Survey #1042',
      sub: 'Standard land ownership record (2.43 ha)',
      filename: 'Khasra_B1_Survey1042.pdf',
      type: 'LAND_RECORD',
    },
    {
      id: 'demo-award-1043',
      title: 'Compensation Award Order — Survey #1043',
      sub: 'Section 23 statutory award determination',
    ...
    <div className="space-y-6">
      ...
      <div className="soft-card p-6 space-y-1">
        <div className="flex items-center space-x-2.5">
          ...
          <h1 className="text-xl font-extrabold text-[#123B5D] tracking-tight">
            Understand your document (दस्तावेज़ समझें)
          </h1>
        </div>
        <p className="text-xs sm:text-sm text-[#667784] mt-1">
          Upload an acquisition-related document to see the important information it contains, translated into simple citizen-friendly language.
        </p>
      </div>
      ...
      <div className="bg-[#FFF9F0] border border-[#E8B84A]/60 rounded-xl p-5 space-y-3 shadow-soft">
        <div className="flex items-center justify-between">
          <span className="text-xs font-bold text-[#123B5D] flex items-center gap-1.5">
            ...
            Official Sample Notices for Instant Verification:
          </span>
          ...
          {demoSamples.map((sample) => (
            ...
            >
              ...
              <span className={`inline-block mt-3 text-[10px] font-bold self-end px-2 py-0.5 rounded ${
                ...
                {activeSample === sample.id && analyzing ? 'Processing...' : 'Verify Document →'}
              </span>
            </button>
          ))}
        </div>
      ...
      <div className="soft-card border-2 border-dashed border-[#DDE6EC] hover:border-[#123B5D] transition p-8 text-center space-y-3">
        ...
        <label htmlFor="file-upload" className="cursor-pointer block space-y-2">
          ...
          <span className="text-sm font-bold text-[#123B5D] block">
            Click to upload paper notice / gazette copy (PDF, JPG, PNG up to 15MB)
          </span>
          <span className="text-xs text-[#667784] block">
            Supported: Section 11(1) Preliminary Notice, Khasra 7/12 records, Section 23/30 Award Orders
          </span>
        </label>
      </div>
      ...
      {analyzing && (
        <div className="soft-card p-8 text-center space-y-3">
          ...
          <p className="text-xs font-bold text-[#123B5D]">
            Running Document OCR & Cross-Verification against Land Revenue Register...
          </p>
        </div>
      )}
      ...
      {analysisResult && extracted && (
        <div className="space-y-6">
          ...
          <div className="soft-card p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 text-xs">
              <div className="bg-[#F8FAFC] p-3 rounded-lg border border-[#DDE6EC]">
                <span className="text-[10px] text-[#667784] font-semibold uppercase block">Survey No.</span>
              ...
              <div className="bg-[#F8FAFC] p-3 rounded-lg border border-[#DDE6EC]">
                <span className="text-[10px] text-[#667784] font-semibold uppercase block">Village</span>
                <span className="text-xs font-semibold text-[#243746] mt-0.5 block">{extracted.village}</span>
              </div>

              <div className="bg-[#F8FAFC] p-3 rounded-lg border border-[#DDE6EC]">
                <span className="text-[10px] text-[#667784] font-semibold uppercase block">District</span>
              ...
              <div className={`p-3 rounded-lg border ${
                ...
                <span className="text-[10px] text-[#667784] font-semibold uppercase block">Notice Area</span>
              ...
              <div className="bg-[#F8FAFC] p-3 rounded-lg border border-[#DDE6EC]">
                <span className="text-[10px] text-[#667784] font-semibold uppercase block">Project</span>
                <span className="text-xs font-semibold text-[#243746] truncate mt-0.5 block">{extracted.project}</span>
              </div>

              <div className="bg-[#F8FAFC] p-3 rounded-lg border border-[#DDE6EC]">
                <span className="text-[10px] text-[#667784] font-semibold uppercase block">Notice Date</span>
              ...
              <div className="bg-[#E8F4EC] border border-[#2E7D5B]/30 rounded-xl p-4 text-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <span className="font-bold text-[#2E7D5B] block">
                    ✓ Matched with Official Cadastral Record:
                  </span>
                  <span className="text-[#243746]">
                    Survey #{matchedParcel.surveyNumber} in {matchedParcel.village} (Officially Recorded Area: <strong>{matchedParcel.recordedAreaHa} ha</strong>)
                  </span>
                </div>
          ...
          {/* DISCREPANCY ALERT BOX (The Key Feature) */}
          {discrepancyResult && (
            <DiscrepancyAlert
          ...
          <div className="soft-card p-6 space-y-3">
            <div className="flex items-center space-x-2 border-b border-[#DDE6EC] pb-2">
              ...
              <h3 className="text-sm font-bold text-[#123B5D]">
                Plain-Language Legal Explanation (सरल शब्दों में सारांश)
              </h3>
            </div>
            ...
            {extracted.actionRequired && (
              <div className="bg-[#EAF3F8] border border-[#DDE6EC] rounded-xl p-3.5 text-xs text-[#123B5D]">
                <span className="font-bold block uppercase text-[10px]">Recommended Citizen Next Step:</span>
