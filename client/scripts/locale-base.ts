...
// Helper function to write a completed locale file
function writeLocale(code: string, nativeName: string, dict: Record<keyof TranslationSchema, string>) {
